...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Greedily merge parts back together (up to chunk_size), recursing
        # into any single part that is still too large on its own.
        chunks: list[str] = []
        buffer = ""
        for part in parts:
            piece = part if not buffer else sep + part
