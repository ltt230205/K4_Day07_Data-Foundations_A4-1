# Le_Tri_Tung-2A202601458

Thư mục cá nhân của Le Tri Tung cho Lab 7: Embedding & Vector Store.

Phần code được chấm chính vẫn nằm ở package `src` cấp trên vì bộ test import trực tiếp `src`.
Thư mục này lưu ghi chú cá nhân và tóm tắt các phần đã hoàn thành.
